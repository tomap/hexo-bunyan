...
[![Build Status](https://travis-ci.org/hexojs/hexo-bunyan.svg?branch=master)](https://travis-ci.org/hexojs/hexo-bunyan)

A forked version of [Bunyan](https://github.com/trentm/node-bunyan) that removes dtrace support.
